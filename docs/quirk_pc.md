...
- **Plantas que crecen desde la piel del PC.** Vines, thorns, flores, raíces — desde la palma, el antebrazo, la espalda,etc. El PC las controla conscientemente. Si las pierde de control, tienen voluntad propia limitada (tienden a proteger al PC).
- **Rewind personal.** El PC puede "guardar" un momento reciente (5–10 segundos al inicio) y "cargarlo" si recibe daño o falla una acción. El rewind afecta solo al PC. Coste: cada rewind deja un "memory scar" — un flash del momento alternativo que ahora no ocurrió.

**Coste:** el uso continuado de plantasangre y rewind desgasta al PC (fatiga, memoria solapada, sangre que sale por poros cuando se esfuerza demasiado).

---

## Aspecto 2 — Avatar Carmesí (Crimson Veins)

**Qué es:** una **proyección humanoide hecha completamente de la sangre del PC**. Tiene la forma del PC, pero su piel es roja sangre, sus ojos brillan (sin iris, sin pupila, sólo luz roja), su cuerpo es fluido. Es sólido cuando el PC quiere, líquido cuando se relaja.

**Cómo se invoca:** el PC vierte suficiente sangre en el suelo y la "despierta" con voluntad. El Avatar cobra forma. Si el PC es herido, el Avatar también lo es (siente el dolor de forma atenuada). Si el Avatar es destruido, la sangre vuelve al PC y se reabsorbe (desmayo leve).
...
**Límite / coste:**
- **Sangre.** Crear el Avatar cuesta sangre. Si el PC lo invoca en combate, va a estar débil después. La sangre se regenera con descanso, comida, hidratación.
- **Vínculo.** El Avatar y el PC sienten el dolor del otro. Si el Avatar sufre un golpe terrible, el PC lo siente.
- **Desaparición.** Si el cuerpo del PC muere o pierde el conocimiento, el Avatar se desintegra. Si el Avatar es destruido, el PC se desangra parcialmente.

**Adulto/edge:**
- El Avatar es una **proyección física del PC** que puede actuar con otros de manera independiente. ¿Es "el PC" si tiene sexo con alguien? Depende de cómo se defina — pero como el Avatar es el PC proyectado, las escenas pueden ser muy íntimas y cargadas (¿el otro sabe que es el Avatar? ¿el PC controla a distancia? ¿el Avatar tiene placer propio?).
- El Avatar puede tomar **forma del interés romántico** (imitando la habilidad de Toga de Transform, pero limitada a su propia sangre) — esto es perturbador y sensual a la vez.
- El Avatar puede "absorber" sangre de otros (con consentimiento o no) para regenerarse o crecer.
...
**Capacidades:**
- **Eco único.** Al inicio, el PC puede invocar un Eco de hace 5–10 segundos. El Eco actúa como el PC habría actuado en ese momento, lo cual puede diferir de lo que el PC hace ahora.
- **Múltiples Ecos.** A mid-game, varios Ecos a la vez (el PC de hace 10s, 30s, 1 minuto). Pueden coordinarse.
- **Tiempo limitado.** Cada Eco dura pocos segundos al inicio, hasta minutos a endgame. Después se desvanece.
- **Memoria de los Ecos.** Cada Eco tiene los recuerdos del PC hasta el momento del save. Si el PC ha cambiado de opinión desde entonces, el Eco puede actuar "en contra" de los deseos actuales del PC — lo cual es narrativamente rico.
...
**Adulto/edge:**
- Los Ecos pueden crear **escenas tensas** — el PC actual está con alguien, y aparece un Eco del PC de hace 1 minuto, que actúa como habría actuado entonces. ¿Confesó antes y ahora se arrepiente? El Eco no lo sabe. ¿Le dijo "te quiero" y ahora quiere retractarse? El Eco ya lo dijo.
- Los Ecos pueden ser **diferentes del PC actual** en personalidad — si el PC ha madurado, el Eco de hace 6 meses puede ser más impulsivo, más ingenuo, más cruel. Esto abre escenas de "conocer a tu yo pasado".
- El rewind personal (que ya tenía el cuerpo) se combina con los Ecos — el PC puede "ver" su pasado mientras rewind, experimentar un momento dos veces con dos perspectivas.
...
### Mid game (stats 5–6, maestría 3–5)
...
El Quirk es **extremadamente poderoso a endgame**, así que los costes son reales:
...
## R6-bis — Drenaje en contexto académico (exámenes, festival, sparrings) — regla S7
Tres niveles, para que Akari no luche "con una mano en la espalda":
1. **SANGRE DERRAMADA (libre, siempre):** la sangre que el combate ya sacó del cuerpo (suelo, ropa, sus propias garras/cuchillas) es recurso libre en CUALQUIER contexto — ya está perdida para su dueño, absorberla no toma nada de nadie. Rendimiento reducido (se degrada fuera del cuerpo): **mitad de recuperación, sin flashbacks**. La savia la absorbe por contacto.
2. **COMBATE OFICIAL SANCIONADO (exámenes, torneos, festival, sparring supervisado):** subir al ring = consentir un duelo de Quirks (doctrina UA; nadie le pide a Bakugo que no explote). Extracción directa PERMITIDA con límites deportivos: **sorbos tácticos** (rendimiento normal, nunca drenar hasta debilitar de verdad), árbitro/Recovery Girl presentes. ⚠️ Los flashbacks NO se apagan: un sorbo directo trae destellos superficiales de la memoria del compañero — intimidad involuntaria. Cortesía mínima: avisarlo antes del combate ("mi Quirk bebe; si te toco con la boca, veré algo tuyo").
...
2. **MEMORIA TRANSMITIDA (recuerdo robado).** Al beber, Akari **ve un recuerdo de la víctima**, elegido por la savia: **aleatorio, incontrolable ni por él ni por ella**. Se narra la visión (breve, encarnada). Coherente con los "flashbacks/destellos" de R6-bis. Con donantes de sintonización completa (Momo) sigue habiendo destello, aunque ya conozca su interior: puede ser un recuerdo nuevo o uno resonante — nunca "de trámite" en la narración. **PRIVACIDAD DEL RECUERDO:** la víctima **NO sabe qué recuerdo se le ha extraído** salvo que Akari se lo cuente; a lo sumo sabe que "ve algo" si él se lo explicó antes (disclosure previo, p.ej. Bakugo). El recuerdo concreto es privado de Akari — compartirlo o guardárselo es decisión suya (no un dato que el mordido perciba solo).
...
## R11-ter — CARGAS DE FRAGMENTO APILABLES (regla de mesa, S17/D19 — decisión del jugador; SUPERSEDE la corrección S16 "1 uso por donante")
**Cada ingesta directa de sangre del cuerpo del donante = +1 carga del fragmento de su Quirk. Sin tope de apilado.** Precisiones:
- **Ingesta directa** = sangre tomada del cuerpo (mordida/drenaje, micro-toma de lanceta, lamido de herida o de piel, de la fuente). **Sangre libre** (ya vertida: cono, sábana, taza, regla recogida de objeto) NO genera carga (precedente Jirō: desfloración libre → sin fragmento).
- **El consentimiento NO es requisito mecánico** — es la ética elegida de Akari, no una condición del Quirk. La savia puede ARREBATAR el fragmento a un enemigo (coherente con §"Drenar villano": fragmento o +1 maestría). Que Akari pida permiso es carácter, no física.
- Cada carga sigue siendo **versión débil, 1 uso / 1 escena, mínima**; el coaching de la donante mejora el rendimiento del uso (nota R11 vigente).
- La oferta de **+1 maestría** sigue apareciendo en cada drenaje y se sigue declinando por defecto (anti-bengala). Las declinaciones no afectan a las cargas.
- ⚠️ OPSEC: cada fragmento usado en público es un TELL del alcance real del Quirk (el camuflaje anti-borrado se paga en discreción).

**INVENTARIO RECONTADO (retroactivo, a D19 mediodía):** Creación (Momo) **×7** (suscripción + drenajes) · Vides (Ibara) **×3** · Invisibilidad (Toru) **×2** · Ácido (Mina) **×2** (drenaje + cata del codo D11) · ONDAS (Nejire) **×2** (resonancia) · ZOOM (Mei) **×1** (2 ganadas, 1 gastada S14) · **Sueño/Somnus (Midnight) ×1** (drenaje D17 — dormía olvidado en el inventario) · Cola/equilibrio (Ojiro) **×1** y Endurecimiento (Kirishima) **×1** (catas directas D11). **Uraraka: 0** — nunca ha habido mordida directa (solo regla/sangre libre); su fragmento de Gravedad está a una mordida de existir.

## R12 — Bestias canon del PC (S8; ampliado S17/D22)
Nombres canonizados: **Blackroot** (lobo — serenidad, freno externo del hambre), **Corvax** (cuervo "negro como la muerte" — ojos aéreos, canal de imágenes, escala hasta MONTURA), **Yogmungard** (serpiente constrictora ~4m — engullir/proteger/evacuar; dentro de ella el PC respira por savia propia), **Grimbark** (gorila de raíces viejas — el puño del bosque, anclar/aguantar/romper),
**BLACKROOT MODO MONTURA (spec canon, S17/D22):** a tamaño de guerra — 2 m a la cruz, 4,5 m de cuerpo sin cola (~5,5-6 m con ella), cabeza de 70-90 cm, masa ~1,5-2,5 t — Blackroot NO es "un lobo grande": es **bestia de guerra legendaria / lobo regio**, una plataforma viva de depredador tamaño rinoceronte pero más larga, baja y amenazante. Capacidad: 1-2 jinetes + carga pesada sin esfuerzo. Velocidades: paso 8-12 km/h · trote sostenido 25-35 · carrera larga 45-60 · **sprint corto 80-100**. Perfil de movimiento: brutal en arrancada y línea recta, MENOS ágil en giros cerrados (la masa manda); cada apoyo a la carrera es un golpe de masa que castiga terreno blando. Sensación en escena: el lomo por encima de la cabeza de un adulto; el jinete no parece ir a caballo sino sobre una muralla que respira. Costes: invocarlo a este tamaño consume pool acorde a la masa (reabsorción devuelve ~90%). **Vesper** (vencejo de quitina y musgo negro — señuelo ultrarrápido y pareja de caza de la munición viva del Ave María; nombrado en la liturgia de la ballesta), y el **linaje de Kioto** (nacidos de guardia en el ryokan, D19-D20): **Myōbu** (zorro vigía de ventanas — rango de la corte de Inari) e **Iemori** (家守, gato guardián de puertas — "el que guarda la casa"). **Órdenes permanentes** (fijadas con Aizawa): si la consciencia de Akari cae con pool>0 → auto-evacuación a destinos rankeados (enfermería → hospital → bomberos) sin esperar orden. Regla personal sellada: **jamás bajar del 20% de pool sin un adulto delante** (a pool 0 la savia hiberna y "la ambulancia muere con el conductor"). La reabsorción devuelve ~90% de la masa invertida. Lección de control multi-bestia: **una voluntad por bestia — nombrar y DELEGAR misiones autónomas** (micro-gestionar tres canales rompe el control a M4).
...
- **Resonancia de multitud** (calmar pánico / desorientar) — la escala de "Arrebato".
- **Coros** — coro de sintonizados **armonizados a nivel de sangre**; el poder **crece con cada integrante** (multiplicador que se compone; curva exacta A CALIBRAR — el jugador retiene "sube con cada uno"). Distinto de la antena: el coro es POTENCIA, la antena es ALCANCE; combinables. Detalle en `docs/quirk_resonancia_arrebato.md` #11.
...
**Mascarada / OPSEC:** la Resonancia es la **cara VISIBLE** que tapa el aspecto temporal (que sigue ROJO absoluto, R14/R15) y, con la estética de sangre (bestias/flora a la vista), tapa también el hambre (drenaje = paleta/arte). Se enseña **TODO el Eco menos el temporal**. **TODAS las sub-técnicas de resonancia (incluida la anulación de Quirks) son PÚBLICAS POR DISEÑO — "los cerezos que cubren el alero"**: el foco/radar que atraen ES el objetivo (cortina de humo del tiempo), no un coste. Única excepción = navegar deltas (ES temporal → ROJO). Detalle por técnica en `docs/quirk_resonancia_arrebato.md`. Doctrina hermana de castaños/alero (Nezu). **Palabra pública = sustantivo de la lección 1 de Midnight (ruta-008) = "ARREBATO"** (Ecos+Sublime; belleza que vibra + terror que eleva). *Pendiente de ENTREGA en ficción a Midnight (aún no se lo ha dicho en escena).*
...
> 🔴 **ERROR TÍPICO A NO REPETIR (ocurrió en S28/D36, `ev-399`)**: se narró que invocar a **Grimbark en King Kong de 10 m** costaba *"~25 % del pool"*. **Falso.** Es coste-por-masa, que en este Quirk **no existe**. Un coloso de 10 m cuesta **5 unidades**, exactamente lo mismo que un cuervo. Si al narrar aparece la tentación de cobrar más por algo grande, la respuesta siempre es **5**.
