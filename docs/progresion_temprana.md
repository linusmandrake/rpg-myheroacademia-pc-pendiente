...
## Arcos 1 (D1–D30): "Llegada e integración"

- **Stats iniciales del PC:** PWR 3, VEL 3, TEC 3, ING 3, COO 3. *(Ajustar si el PC es un héroe más curtido de otra escuela — el intercambio puede llegar con stats 4–5 ya entrenados.)*
- **Quirk maestría:** 2.
- **Edad PC:** 18+.
- **Closeness con todos los NPCs:** 0 al llegar. Empieza a construir desde cero.
- **Hitos de integración marcados (peso narrativo 1 cada uno):**
  - Primer día en UA: peso 1 (color).
  - Primer entrenamiento compartido: peso 1.
