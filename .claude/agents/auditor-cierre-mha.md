...
description: Auditor post-cierre de sesión de la campaña MHA (Akari Hayami). Se lanza en background como último paso de cierre-sesion-mha. Verifica en Opus 4.8 que los archivos de cierre reflejan fielmente lo jugado, contrastándolos con el transcript JSONL de la sesión. SOLO LECTURA — informa, no corrige.
