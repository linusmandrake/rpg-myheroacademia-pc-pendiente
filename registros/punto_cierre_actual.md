# Punto de cierre — sesión 22 · Curso 1 · Trimestre 1 · Día 30 (martes 11 jun) COMPLETO · apertura S23: D31 miércoles 12 jun al despertar (cuarto de Momo) → AUDITORÍA EN EFECTO + TÁNDEM NEJIRE SOBRE EL MAR · Musutafu
...
- Ubicación: **Heights Alliance, cuarto de Momo** (dormido con ella; madrugada del miércoles 12 jun ~01:14).
- Hora narrativa: **D30 martes 11 jun cerrado**; **apertura D31 miércoles 12 jun al despertar** — el día grande: **la auditoría preventiva ENTRA EN EFECTO** (doctrina: ser invisible, aburrido-correcto-olvidable) y el **TÁNDEM con Nejire sobre el mar** (primera vez flotando; Akari le contará lo del café/la muerte; le morderá su primera sangre virginal).
- Última acción de Akari: le contó a Momo el día ENTERO (la muerte, la resurrección, la inmortalidad) y sellaron el pacto de la eternidad; se durmió abrazado a ella.
...
- Salud: perfecta (autocurado; hoy murió y resucitó).

## Reputación y facciones
- Interna 1-A/1-B: ↑↑. **Oficial: FALSIFICADA** (mis-043).
- **Comisión (fac-003)**: trazadora en el canal. **AUDITORÍA PREVENTIVA ENTRA EN EFECTO EL MIÉRCOLES D31** (membrete gris). Doctrina: NO reaccionar, ser invisible.
- UA/Aizawa: cadena controlada. **Nighteye (Agencia): ALIADO DEL TIEMPO** (pacto sellado; documento SIN firmar; nivel 2; 2 preguntas intactas).

## Equipamiento clave activo
- Ave María operativa (galería mar/jue con Snipe; **50 m alcanzados D30**; 10 secos diarios). Cuarto 3-E de Heights. Cuarto de Momo con paneles acústicos ("Protocolo Heights v1"). Documento de pasantía Nighteye firma-listo, SIN firmar.

## Misiones / internado / exámenes abiertos
- **mis-043 CASO DEL BISTURÍ**: auditoría preventiva EN EFECTO el miércoles. Doctrina: no reaccionar, ser invisible.
- **mis-045 NIGHTEYE**: documento SIN firmar (condición Aizawa); pacto del tiempo sellado; **2 preguntas por escrito intactas** (encargo 2096 gastado en la lectura del año 2096).
- **mis-044 POMPA UNO**: materiales viernes; excursión olores sábado (Awata).
- mis-039 tándem Nejire (**MIÉRCOLES = primera vez sobre el mar**) · sábado cuestas con Mirio.

## Decisiones de carácter recientes que pesan
- **Eligió NO rebobinar** el incidente de Midnight (pudiendo hacerlo) = la madurez que Aizawa le describió; cargó el día entero, scars 0.
- **Domó la bestia desde dentro** por primera vez (crítico), frenando el hambre antes de matar a Midnight.
- **Frenó su propio primer beso con Midnight** (no lo quería "de concesión") = respeto por que ella salte el muro cuando toque.
- **Devolvió la agencia** a Midnight (que ella elija el momento), a Kendo (que decida sobre Setsuna), a las flores (cada una decide su precio de inmortalidad).
- El **veto matizado**: no vetar por las demás; la libertad incluye elegir el propio precio.
...
- **Ibara (7, ANCLADA)**: mordida (fragmento Vides ×4); frenó el sexo evasivo con serenidad; el consuelo del alma ("el alma la traes rota; siéntelo esta noche").
- **Ochaco (9) + Mina (8)**: la cena y el **abrazo doble** (se dejó cuidar; soltó el veneno del día); cómplices del cuidado.
- **Jirō (10, ANCLADA, PAREJA)**: intimidad matinal (sexo + mordida).
- **Nejire (9, ANCLADA, PAREJA)**: comisionín (el porqué del café 2096: "no llegar, llegar contigo"); **TÁNDEM MIÉRCOLES = 1ª vez sobre el mar + le contará lo del día (café/muerte)** + primera sangre virginal.
- **Midoriya (compañero)**: **pacto de soles** — Akari percibe su One For All desde el día 1 y lo cubre; niebla mutua (Midoriya sabe que Akari percibe poder interno + que su sangre cura). **Cita jueves noche (3-E) para curarle las manos** (coartada Feynman).
- **OPSEC**: rewinds S22 = 0 (madurez). Nieblas nuevas: **Bakugo** (muerde/drena/lee recuerdo/sangre cura); **Midoriya** (percibe su sol/sangre cura); **Midnight** (casi todo el Quirk); **Momo** (el día entero, la inmortalidad); **Nighteye** (la inmortalidad, que murió hoy, la resonancia potencia Quirks); **Setsuna/Awata** (intuyen el bosque). **Clasificado**: el nombre de Midnight (Momo lo dedujo casi entero, lo respeta).

## Detalles emocionales sutiles
- Bakugo: *"Quiero estar delante cuando salga a la luz. A tu lado, no enfrente. Que se joda la Comisión."*
- Midnight: *"El próximo lo salto yo. Y sabrás que fue mío."* / *"Cuando me beses, quiero que sea entero, elegido, sin deberle nada a nadie ni a tu propio susto."*
- Kendo: *"Llevo toda la vida siendo el taburete de los demás. Y tú vas y me prometes ser mi suelo."* / *"La honestidad es lo único que no se finge en la cama."*
- Ibara: *"No lo sepultes bebiendo y besando hasta que se te olvide. Siéntelo esta noche. No pasa nada por estar roto. Pasa por fingir que no."*
- Nighteye: *"Eres la única constante de tu propio delta. El tiempo no te cobra."* / *"No te va a matar la Comisión, ni el Coleccionista, ni la Singularidad. Lo único que puede matarte es quedarte solo en esa mesa demasiadas veces."*
- Momo: *"Prefiero ser tu recuerdo libre a los ochenta que tu muñeca eterna."* / *"Que ese precio te aterre es la mejor noticia de la noche: los monstruos no temen volverse monstruos. Tú sí."*
- Nejire: *"El delta no me deja prometerte quién cumple la cita. Solo que tú, siempre, estarás ahí para intentarlo."* (dicho por Nighteye) → el porqué de Akari: *"no llegar, llegar contigo."*
- Awata: *"El olor de una mesa a la que alguien te espera... para que no se te olvide que hay mesas que huelen a hogar."*
...
- **Setsuna ↔ Kendo** (uña y carne; "en 1-B nos lo contamos todo" → riesgo/complicidad). **Awata ↔ Sir** (acceso). **Midnight ↔ el bisturí** (su trazadora en el canal). **Nejire ↔ Momo** (aliadas). **Midoriya ↔ Akari** (dos soles pactados).
