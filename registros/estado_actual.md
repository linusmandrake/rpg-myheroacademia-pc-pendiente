...
> Última actualización: 2026-07-21 · **SESIÓN 29 CERRADA** · Curso 1 · T1 · **Día 37 completo (martes 18 jun)**, cierre a las **~22:15**.
...
## Arcos abiertos
- **Arco 2 (D31–D60)** — prácticas y licencia (lista esta semana).
- **Dar luz al bosque** — el harem pasa de estrella a red (nodos); identidad de Momo (árbol) sigue secreta salvo Akari/Yuyu/Midnight.
- **La Serie S / La Oficina** (`mis-046`) · **Hosu / Hero Killer** (`mis-047`, Keystone Guard/Seo) · **semana de Kuroda** (`mis-043`, →viernes) · **la versión oscura** · **el uroboros**.

## Misiones activas
`mis-047` Hosu · `mis-046` Serie S/Oficina · `mis-043` auditoría · `mis-045` Nighteye (firmar tras el viernes) · `mis-044` Pompa Uno (Mei) · `mis-034` aula de repaso → reforma de corrección ciega (arranca lunes).

## Hilos narrativos
- 🔴 **Cucharita mañanera con Mina** (D38 alba).
- 🔴 **Miércoles D38**: primera clase de **Rescate con Trece** (franja doble tarde) tras la noche.
- **Cura de la espalda de Anan** pactada el **viernes** (fin de Kuroda).
- **Jueves D39 16:00**: cita Nezu (sorpresa: **Ryukyu**) + deriva de Mei (encargo de Snipe).
- Presentar a **Setsuna** (libre) · preguntar a **Awata** si quiere nodo · avatar-conducto de Anan por reabsorber.
- Noche del Nodo 4 (Yuyu/Nejire/Mei) · noche de los tres (Momo/Nemuri) · sorpresa que Kendo quiere devolver · Jirō "con intereses".
- Micelio-hijo: qué es y hasta dónde crece. Stain/Yaeko/Togeike/Tsubaki (hilos S28 vivos).

## Economía
**¥95.770 · sin deudas** · cero movimientos en D37 · beca ~julio.

## Reputación y facciones
**Bajo perfil de auditoría intacto** (todo en salas selladas / Gamma vacío / dormitorios; Kuroda verde toda la jornada; espionaje activo sobre ella desactivado). **UA**: Aizawa/Nezu socios; **Midnight ahora sabe la identidad de Momo**. **Comisión**: Kuroda →viernes.

## Hitos conseguidos (S29)
