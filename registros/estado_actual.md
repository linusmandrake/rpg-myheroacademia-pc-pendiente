...
## Arcos abiertos
- **Arco 2 (D31–D60)** — prácticas y licencia.
- **La Serie S / La Oficina** (`mis-046`) · **semana de Kuroda** (`mis-043`, →viernes; ella ha empezado un cuaderno que no es de la oficina) · **Hosu / Hero Killer** (`mis-047`).
- **Dar luz al bosque** — de estrella a red por nodos; el árbol sigue oculto (solo Akari, Yuyu y Midnight).
- **La forma completa del dragón** — el cuerpo ya la pide con las dos membranas puestas. Sin ejecutar.
...
- **Reputación de campus: salto grande** — 1-A y 1-B en el mismo césped, dos profesores presentes, cero incidentes.
- UA: máximos históricos (Aizawa avala tácitamente; **Present Mic entra al radar**). Comisión: sin movimiento sobre él. Liga / Hassaikai / Stain: sin contacto.

## Hitos conseguidos (S30)
- `RC-DRAGON-SEG-01` **cumplida en una tarde**: cambio de ala en vuelo dominado.
- **Las alas transductoras** (Fase 3 sobre superficie alar).
- **Primer Eco fuera de sangre vinculada** — `ruta-013` consolidada.
- `mis-049` cumplida con Trece, en público, sin una grieta.
- Acuerdo nuevo del marco con Momo: *"la línea no es el dial, es que yo esté dentro."* + promesa de los 1.400 m.
- Declaración "alma copiloto" a Nejire, a Eco-0.

## Progresión
- **Bote de arco** (nada concedido): TEC 1 · ING 2+1 · CARÁCTER 3 · VÍNCULOS 3+2+2 · VEL 2 · VEL/TEC 1 · **TEC/Quirk 2** · **Quirk/control 2** · VÍNCULOS/COO 1 · académico 1. Marcas S26/S27 aún sin evaluar.
